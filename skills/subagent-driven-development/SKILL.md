...
After reading the plan, before executing any task:
...
## Strict TDD Per-Task Flow (Optional)

For projects requiring strict TDD role separation, use this alternative per-task flow:
...
- `./tester-prompt.md` - Dispatch tester subagent (for strict TDD)
- `./developer-prompt.md` - Dispatch developer subagent (for strict TDD)
- `./implementer-prompt.md` - Dispatch implementer subagent (standard flow)
